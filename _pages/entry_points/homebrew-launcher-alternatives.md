...
Первичной точкой входа называют такую точку, для работы которой не требуется ничего, кроме самой игры. Рекомендуемой первичной точкой входа является [Steelminer](steelminer){:target="_blank"} в виду своей бесплатности. 

...
**О:** Да, можно, с помощью специального флеш-картриджа, например R4 или его аналога. С внутренней памяти можно через [TWiLightMenu++ и nds-bootstrap](https://vk.com/@3ds_cfw-faq-po-dsimenu-i-nds-bootstrap){:target="_blank"}, но этот метод работает плохо. 

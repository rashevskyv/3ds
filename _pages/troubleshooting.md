...
Часто такая ошибка может возникать при запуске игры чужого региона. Если игра работала, но вдруг перестала после очередного обновления, или установки DLC - скорее всего причина именно в неродном регионе. Можно обмонуть игру, воспользовавшись [lumalocale switcher](lumalocales)

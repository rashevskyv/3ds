...
1. Нажмите (A), чтобы удалить повреждённые тайтлы TWL
...
## Ошибка "Failed to apply 1 FIRM patche(s)"

1. Обновите [Luma3DS](update-luma3ds){:target="_blank"}. 

## Пропали все игры на стартовом экране, хотя место на карте они так и занимают, а в настройках на них серые кресты 

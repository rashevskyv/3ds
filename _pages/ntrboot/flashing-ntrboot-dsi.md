...
* Две консоли 
  + **Исходная DSi**: Nintendo DSi, совместимая с вашим флеш-картриджем
...
1. Вставьте ваш DS / DSi флеш-картридж, совместимый с ntrboot, в **исходную DSi**

### Часть II - Прошивка ntrboot

1. Запустите `ds_ntrboot_flasher_dsi.nds` на **исходной DSi**, используя флеш-картридж

...
1. [Обновите и скрипты и godmode9](/godmode9-usage#обновление-godmode9)
...
1. [Обновите и скрипты и godmode9](https://3ds.customfw.xyz/godmode9-usage#обновление-godmode9)
1. [Запустите GodMode9](/godmode9-usage#Запуск-godmode9), держа нажатой кнопку {% include inc/btn.txt btn="START" %} во время загрузки

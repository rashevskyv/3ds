...
1. Зажмите {% include inc/btn.txt btn="R" %}, затем нажмите {% include inc/btn.txt btn="X" %} на файле `00000000`, чтобы переименовать его
1. Нажмите {% include inc/btn.txt btn="UP" %}, чтобы переименовать файл в `10000000`
1. Нажмите {% include inc/btn.txt btn="A" %}, чтобы сохранить изменения

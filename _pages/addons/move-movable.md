...
- **Целевая 3DS** - приставка на какую вы хотите перенести данные
	- **Обе приставки должны быть взломаны!** Если вы планируете взламывать целевую приставку [методом DSiWar](installing-boot9strap-dsiware-game-injection){:target="_blank"}, то при выполнении этого метода вы и так перенесёте все данные с целевой приставки на исходную. 

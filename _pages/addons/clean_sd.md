---
title: "Восстановление прошивки на SD-карте" #
lang: ru
...
## Описание шагов
Бывают случаи, когда по каким-то причинам вы теряете все данные на SD-карте и у вас нет ее бекапа. В этой инструкции мы рассмотрим все варианты восстановления работоспособности консоли в такой ситуации.

### Часть I - Определение версии загрузчика 
Сначала нужно определить каким методом приставка взломана. 

#### Часть I (i) - Если приставка загружается
...
#### Часть I (ii) - Если приставка не загружается
...
#### Часть II - Установка программного обеспечения 
...
1. Поставьте галочку напротив первого пункта - "Авто-обновление ключей приложения через URL"
	+ Если галочка уже стоит и там вписан URL-адрес, нажмите на иконку корзины, чтобы его удалить

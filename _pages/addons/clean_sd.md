...
1. Завершите установку приложений по это инструкции, начиная с **Части II** и следуя пунктам до конца страницы - [Завершение установки: запуск OCS](https://3ds.customfw.xyz/finalizing-setup#часть-ii---запуск-ocs). 
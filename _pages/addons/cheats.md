...
1. Закройте меню Rosalina, нажатием кнопки {% include inc/btn.txt btn="B" %} несколько раз
	* Если вместо списка читов вы видите надпись "No suitable title found", вы скорее всего перепутали Title ID игры, либо не положили `cheats.txt` в соответствующую папку

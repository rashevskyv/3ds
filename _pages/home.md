...
header:	
  ...
  overlay_filter: 0.5
  caption:
excerpt: 'Полное руководство по прошивке 3DS<br />**Последнее изменение:** 30 апреля'
---
...
+ SD-карта должна быть в формате [FAT32](http://customfw.xyz/format_sd){:target="_blank"}
